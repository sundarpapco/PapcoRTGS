...
import com.papco.sundar.papcortgs.ActivityEmail;
import com.papco.sundar.papcortgs.GroupActivity;
import com.papco.sundar.papcortgs.R;
import com.papco.sundar.papcortgs.SmsService;
...
public class EmailService extends Service implements EmailCallBack {
    ...
    public void setCallBack(EmailCallBack callBack){
        ...
        if(workingStatus==WORK_STATUS_WORKING){
            if(weakCallback.get()!=null && emailList!=null){
               weakCallback.get().onUpdate(emailList);
            }
        }
    ...
    public void onUpdate(List<Transaction> list) {
        ...
        if(weakCallback.get()!=null && list!=null){
            weakCallback.get().onUpdate(list);
        }
